...
AI2_SCORECARD = {
    "version": "ai2_mobile_adtech_v2026_04",
    "description": "Quantified smartphone-OEM scorecard for mobile ad AI, measurement, monetization, and AdTech infrastructure.",
    "weights": {
        "A": {"label": "OEM ad-surface partnership possibility", "points": 20},
        "B": {"label": "Minority stake / bolt-on / strategic acquisition fit", "points": 20},
        "C": {"label": "On-device, SDK, and deployment integration ease", "points": 15},
        "D": {"label": "Data, privacy, and regulatory readiness", "points": 15},
        "E": {"label": "Ad performance and commercial proof", "points": 15},
        "F": {"label": "Strategic differentiation and defensibility", "points": 10},
        "G": {"label": "Financial stability and execution", "points": 5},
    },
    "subcriteria": {
        "A": [
            {"id": "A1", "label": "OEM channel fit", "points": 5, "rubric": "supported OEM placements such as preload, app store, browser, system feed, lock screen, or recommendation surfaces"},
            {"id": "A2", "label": "Integration burden", "points": 4, "rubric": "SDK size, API quality, SSO or permissions flow, MMP support, and deployment lead time"},
            {"id": "A3", "label": "Commercial proof", "points": 4, "rubric": "public installs, MAU or DAU reach, ROAS uplift, retention uplift, or advertiser logos"},
            {"id": "A4", "label": "Regional and customer coverage", "points": 4, "rubric": "supported countries, OEM or telco partner count, and Android-heavy market fit"},
            {"id": "A5", "label": "Brand and regulatory safety", "points": 3, "rubric": "ATT, SKAN, Privacy Sandbox, fraud controls, brand safety, and sensitive-category discipline"},
        ],
        "B": [
            {"id": "B1", "label": "Strategic synergy", "points": 5, "rubric": "fit with OEM app store, browser, AI agent, recommendation, and ad-revenue strategy"},
            {"id": "B2", "label": "Deal feasibility", "points": 4, "rubric": "valuation realism, company scale, funding stage, and realistic buyer set"},
            {"id": "B3", "label": "Integration ease", "points": 4, "rubric": "product complexity, key-person dependency, data migration risk, and services burden"},
            {"id": "B4", "label": "Asset scarcity", "points": 4, "rubric": "exclusive distribution, OEM inventory access, proprietary data, model performance, or rights hard to replicate"},
            {"id": "B5", "label": "Financial case", "points": 3, "rubric": "revenue band, synergy potential, and likely EV-to-revenue sanity for tuck-in deals"},
        ],
        "C": [
            {"id": "C1", "label": "Supported OEM surfaces and placements", "points": 5, "rubric": "preload, app discovery, store placement, browser placement, lock screen, notification, or recommendation support"},
            {"id": "C2", "label": "SDK and API maturity", "points": 4, "rubric": "SDK maturity, docs, sample apps, reporting, and permissions hygiene"},
            {"id": "C3", "label": "Measurement and MMP interoperability", "points": 3, "rubric": "AppsFlyer, Adjust, Branch, SKAN, AdAttributionKit, or equivalent integration support"},
            {"id": "C4", "label": "Deployment lead time and ops load", "points": 3, "rubric": "time to launch, QA burden, and OEM operations complexity"},
        ],
        "D": [
            {"id": "D1", "label": "ATT and SKAN readiness", "points": 5, "rubric": "privacy-safe iOS measurement and attribution support with current platform framing"},
            {"id": "D2", "label": "Android privacy and first-party resilience", "points": 4, "rubric": "first-party, contextual, clean-room, or privacy-safe measurement logic without outdated policy assumptions"},
            {"id": "D3", "label": "Fraud, brand safety, and governance", "points": 3, "rubric": "fraud prevention, quality filters, governance, or audit-friendly controls"},
            {"id": "D4", "label": "Cross-region regulatory readiness", "points": 3, "rubric": "DMA, GDPR, US state privacy, platform policy, and multi-region rollout readiness"},
        ],
        "E": [
            {"id": "E1", "label": "Reach, revenue, and pricing proof", "points": 5, "rubric": "public reach, installs, device footprint, revenue band, monthly pricing, take rate, or repeat contract evidence"},
            {"id": "E2", "label": "Performance metrics", "points": 5, "rubric": "CPI, CPA, ROAS, retention, fill rate, eCPM, or other measurable commercial outcomes"},
            {"id": "E3", "label": "Customer quality and repeatability", "points": 5, "rubric": "advertiser, publisher, OEM, or telco logos plus repeat use or multi-region scale"},
        ],
        "F": [
            {"id": "F1", "label": "Exclusive distribution or channel rights", "points": 4, "rubric": "OEM inventory access, regional exclusivity, or hard-to-replace channel control"},
            {"id": "F2", "label": "Model and measurement moat", "points": 3, "rubric": "creative AI, bidding, measurement, or optimization engine with credible differentiation"},
            {"id": "F3", "label": "Lock-in and surface ownership", "points": 3, "rubric": "workflow depth, data gravity, and OEM-surface ownership that make replacement harder"},
        ],
        "G": [
            {"id": "G1", "label": "Funding and runway", "points": 2, "rubric": "recent funding, survivability, or profitability signal"},
            {"id": "G2", "label": "GTM and enterprise responsiveness", "points": 2, "rubric": "enterprise support, SLA, onboarding discipline, and regional execution maturity"},
            {"id": "G3", "label": "Operational focus", "points": 1, "rubric": "clear operating model without excessive fragmentation"},
        ],
    },
    "required_tracking_fields": [
        "last_funding_date",
