...
PHASE_CONTRACTS: dict[str, PhaseContract] = {
    ...
    "ai1_candidate_verify": PhaseContract(
        ...
        domain="ai1",
        purpose="Verify newly scouted AI/1 candidates before scoring.",
        ...
        gates=("required_hq_source", "no_korea_china_hq", "no_unicorn", "all_numbers_cited", "no_duplicate_company_id", "mobile_fit_confirmed"),
        timeout_minutes=18,
        retry_policy=RetryPolicy(max_attempts=1),
        evidence_contract=EvidenceContract(min_sources_per_core_claim=1, min_sources_for_mutable_claim=2, max_staleness_days=14),
        fail_closed_fields=("headquarters_country", "unicorn_status", "category", "funding_amount", "valuation"),
        page="ai1",
        kst_slot="05:10 KST",
    ),
    ...
    "ai1_score": PhaseContract(
        ...
        kind="score",
        domain="ai1",
        purpose="Compute deterministic AI/1 scores from verified evidence-backed inputs only.",
        ...
        gates=("deterministic_formula_used", "unsupported_claims_zero_weight", "ranking_tiebreak_applied"),
        timeout_minutes=15,
        retry_policy=RetryPolicy(max_attempts=1),
        evidence_contract=EvidenceContract(min_sources_per_core_claim=1, min_sources_for_mutable_claim=2, max_staleness_days=14),
        fail_closed_fields=("score_input", "ranking_claim"),
        page="ai1",
    ...
    "ai2_candidate_verify": PhaseContract(
        ...
        kind="candidate_verify",
        domain="ai2",
        purpose="Verify newly scouted AI/2 candidates before scoring, including privacy-measurement and deprecation risk.",
        ...
        gates=("required_hq_source", "no_korea_china_hq", "no_unicorn", "all_numbers_cited", "no_duplicate_company_id", "mobile_adtech_fit_confirmed"),
        timeout_minutes=18,
        retry_policy=RetryPolicy(max_attempts=1),
        evidence_contract=EvidenceContract(min_sources_per_core_claim=1, min_sources_for_mutable_claim=2, max_staleness_days=14),
        fail_closed_fields=("headquarters_country", "unicorn_status", "category", "funding_amount", "valuation", "policy_drift"),
        page="ai2",
        kst_slot="06:52 KST",
    ),
    ...
    "ai2_score": PhaseContract(
        ...
        kind="score",
        domain="ai2",
        purpose="Compute deterministic AI/2 scores from verified evidence-backed inputs only.",
        ...
        gates=("deterministic_formula_used", "unsupported_claims_zero_weight", "ranking_tiebreak_applied", "deprecated_adtech_thesis_blocked"),
        timeout_minutes=15,
        retry_policy=RetryPolicy(max_attempts=1),
        evidence_contract=EvidenceContract(min_sources_per_core_claim=1, min_sources_for_mutable_claim=2, max_staleness_days=14),
        fail_closed_fields=("score_input", "ranking_claim", "policy_drift"),
        page="ai2",
